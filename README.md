...
## Builing Binaries
### Portable versions
The portable executables can be generated by simply executing:
```sh
$ make
```
The detailed instruction for Linux and Windows on portable versions are provided by [Microsoft Research](https://github.com/Microsoft/PQCrypto-SIDH/blob/master/README.md).
